...
- [x] `examples/pore-mesh-redistribution` — `redistribute_pore_mesh` [now
      `peclet.voro.pore_mesh.redistribute_pore_mesh`, returning a `RedistributeResult` — F, 2026-09-10]
      from a mismatched start:
