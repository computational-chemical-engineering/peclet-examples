...
interval it assumes). A shipped-defaults run (no tuning flags: telescoping on, residual stop 1e-5,
the velocity-MG auto rule) reproduces the tuned rows within that spread.
