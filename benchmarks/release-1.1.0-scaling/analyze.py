...
# Quantities the page uses to say what a feature of the ladder is NOT: the all-reduce's share of
# the projection, the depth of the multigrid hierarchy along the weak ladder, and the per-phase
# timers around any non-monotone rung. Every one is derived from THIS record's own runs -- this
...
def main():
    ...
    hl = headline(runs)
    hl.update(structural(runs, here))
