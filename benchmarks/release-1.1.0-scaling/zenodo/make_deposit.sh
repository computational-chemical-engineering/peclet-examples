...
# THIS RECORD ARCHIVES ONE IMPLEMENTATION. The 1.0.0 deposit also swept in the sibling
# benchmarks/momentum-solver campaign, because its addendum quoted that campaign's numbers. This
# record quotes nothing from any other version, and a sibling directory full of 1.0.0 and 1.0.1 runs
# in the tarball would contradict the scope its own description states. Package THIS directory only.
