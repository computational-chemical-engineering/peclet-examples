...
::: {.callout-important title="One state, 28 runs, two machines"}
$\langle u \rangle = 1.638889605549e-04$

across **28 runs** spanning 1 to 768 ranks, both the CUDA and the OpenMP
...
The runbook is [`README.md`](README.md); the design decisions, including the ones that were
rejected, are in [`DECISIONS.md`](DECISIONS.md).

## Cite

The archived record — data, scripts and this report — carries its own DOI. Cite the **concept DOI**
so the reference follows later versions rather than going stale.
