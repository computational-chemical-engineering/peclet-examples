#!/bin/bash
# ==========================================================================================
# Build the Zenodo deposit for the peclet 1.0.0 scaling benchmark, and (only when asked)
...
cd "$(dirname "$0")/.."
BENCH="$PWD"
NAME="peclet-flow-1.0.0-scaling"
...
{
  echo "peclet.flow 1.0.0 scaling benchmark — provenance"
  echo
  echo "packaged          : $(date -Is)"
  echo "peclet-examples   : $COMMIT"
  echo "software          : peclet 1.0.0 (all packages tagged v1.0.0, 2026-09-12)"
