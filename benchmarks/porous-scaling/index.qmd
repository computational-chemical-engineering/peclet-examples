...
where its march is stable (np=16: 6966→4281 ms/step). One anomaly: the np=8 rungs' *projection*
phase is slower under CA (cut-cell 342→465 ms) even as momentum improves — net still faster
(1239→988) but worth a targeted look; np=16/32 show the opposite, large, expected gains.
