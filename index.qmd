...
continuum surface force, and momentum-consistent advection at large density ratios. Each page is
gated against something outside the solver — an exact algebraic identity, the exact viscous
normal modes, and a published benchmark.
...
The classic settling benchmark as an honest negative result — one that already bought a real
solver fix, kept measuring after it landed, and still stands as the sharpest open problem.
[flow · dem · coupling · negative result]{.tags}
