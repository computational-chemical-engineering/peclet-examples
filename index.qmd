...
## Start here: the 1.0.0 film

:::::: {.section-lead}
Seven minutes on what the suite does and — at length — the evidence for it: the exact solutions
first, then published experiments, then performance measured against another open-source solver on
the same grid and the same machine.
