...
The classic settling benchmark as an honest negative result: the coupling checks out to 2%,
and the miss it measures pins the solver's sharpest open item — the advective cut-wall flux.
