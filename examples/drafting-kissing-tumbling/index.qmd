...
```{python}
#| label: driver
def run(DH, steps_max=4000, offset=0.005, adv_scheme='koren'):
    RATIO = RHO_S / RHO_F
    ...
    assert s.diagnostics.periodic_image_overlap_cells() == 0
    ...
    d.initialize_shape('sphere', DH / 2); d.set_dt(dt / 10)
