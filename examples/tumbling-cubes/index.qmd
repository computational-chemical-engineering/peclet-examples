...
built-in **cube** (`initialize_shape('box', …)`) collides *every face* against its neighbours and against
...
<div class="ratio ratio-16x9" style="max-width:900px;margin:0 auto;">
  <iframe src="https://www.youtube.com/embed/aJamq90JIEw?rel=0&amp;modestbranding=1&amp;autoplay=1&amp;mute=1&amp;loop=1&amp;playlist=aJamq90JIEw"
          title="Tumbling cubes in a rotating drum — GPU DEM with non-spherical grains"
...
A cube is one call: `initialize_shape('box', half_extent)`. The drum is a **z-periodic SDF barrel**
...
sim.initialize_shape('box', he)                 # a cube of half-extent he
sim.set_domain(lo, hi); sim.set_periodic(False, False, True)
...
sim.set_gravity((0, -g, 0)); sim.set_material_params(0.2, 0.0, 0.5); sim.set_solver_iterations(18, 6); sim.set_dt(dt)
...
- **Other shapes.** `initialize_shape('hollow_cylinder', …)` for Raschig rings, or an arbitrary SDF
