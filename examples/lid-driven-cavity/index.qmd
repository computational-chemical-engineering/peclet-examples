...
[![Download notebook](https://img.shields.io/badge/Download-notebook-F37626?logo=jupyter&logoColor=white)](https://github.com/computational-chemical-engineering/peclet-examples/blob/main/examples/lid-driven-cavity/index.ipynb){target="_blank"}
...
def solve_cavity(N=64, Re=100.0, U=1.0, nz=4, dt=2.0, max_steps=2500):
    ...
    s.set_domain_bc('+y', 'inflow', velocity=(U, 0.0, 0.0))                                    # +y lid moving in +x
