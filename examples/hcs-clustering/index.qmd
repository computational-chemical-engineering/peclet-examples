...
def cool(e, T0=9.0, nsteps=2200, dt=0.02, seed=1):
    ...
    d.initialize_shape(shape_type=1, radius=rp); d.set_sphere_shape(rp)
...
dc = dem.Simulation(Nc+64); dc.initialize_shape(shape_type=1, radius=rp); dc.set_sphere_shape(rp)
