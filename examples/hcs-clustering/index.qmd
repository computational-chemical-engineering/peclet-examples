...
- **Coarsening sets the filament count.** Early the pattern is many fine filaments (our t\* = 2000);
  ...
  match our **earlier** snapshots more than our latest. The one genuine physical difference is that our
  density filaments coarsen somewhat faster / onset a little later in t\* than the benchmark's — a
  timestep-converged result (finer dt does not change it), most likely the collisional-dissipation
  detail of the contact solve inside the densifying clusters. The instability, its energy signature, and
  its filamentary morphology are all reproduced.
:::
