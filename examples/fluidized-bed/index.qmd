...
[![Download notebook](https://img.shields.io/badge/Download-notebook-F37626?logo=jupyter&logoColor=white)](https://github.com/computational-chemical-engineering/peclet-examples/blob/main/examples/fluidized-bed/index.ipynb){target="_blank"}
...
def make_flow(U):
    ...
    s.set_domain_bc('-z', 'inflow', velocity=(0.0, 0.0, U))     # -z: inflow, gas up at U
    s.set_domain_bc('+z', 'outflow')                 # +z: outflow
    for f in ('-x', '+x', '-y', '+y'): s.set_domain_bc(f, 'wall')   # lateral no-slip
...
def make_dem(pos):
    ...
    d.initialize_shape('sphere', radius=rp)        # sphere at the real grain radius (any unit works)
...
a void-fraction floor (`eps_min`, default 0.25), below which the drag correlations are not evaluated.
...
<div class="ratio ratio-16x9" style="max-width:900px;margin:0 auto;">
  <iframe src="https://www.youtube.com/embed/hYOgKVjl_SI?rel=0&amp;modestbranding=1&amp;autoplay=1&amp;mute=1&amp;loop=1&amp;playlist=hYOgKVjl_SI"
          title="A million-particle fluidized bed on one GPU — online CFD–DEM coupling"
