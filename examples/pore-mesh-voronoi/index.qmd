...
```{python}
#| label: run
opt = dict(method="steepest", max_iter=30, sw=6)                # position-only descent on the walls

s1 = pm.seed_pore_space(centres, radii, L, n_bulk=2000, graded=False, wall_per=80, seed=1)
...
s3 = pm.seed_pore_space(centres, radii, L, n_bulk=2000, graded=True, wall_per=80, seed=3)
