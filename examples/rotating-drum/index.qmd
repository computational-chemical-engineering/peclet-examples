...
[![Download notebook](https://img.shields.io/badge/Download-notebook-F37626?logo=jupyter&logoColor=white)](https://github.com/computational-chemical-engineering/peclet-examples/blob/main/examples/rotating-drum/index.ipynb){target="_blank"}
...
def fill_drum(friction_wall=1.0, friction_grain=0.7, fill=0.42):
    ...
    sim.set_periodic(False, False, True)     # periodic along the drum axis
    ...
    dt, crit = 0.003, 0.06; sim.set_dt(dt)
...
t0 = time.time()
sim, wid, N = fill_drum()
print(f"packed {N} grains in {time.time()-t0:.1f} s; max overlap = {sim.max_overlap:.3f} (grain r = 1)")
```
